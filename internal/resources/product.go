...
var Product = &crud.Resource{
	...
	Fields: []schema.Field{
		...
		{Name: "product_name", Kind: schema.KindString, Required: true, MaxLen: 255, Label: "ชื่อสินค้า"},
...
var ProductSKU = &crud.Resource{
	...
	Fields: []schema.Field{
		...
		{Name: "variation_name", Kind: schema.KindString, MaxLen: 100, Label: "ชื่อรุ่น/แบบ"},
		{Name: "issue_no", Kind: schema.KindString, MaxLen: 50, Label: "ฉบับที่"},
		{Name: "volume_no", Kind: schema.KindString, MaxLen: 50, Label: "เล่มที่"},
