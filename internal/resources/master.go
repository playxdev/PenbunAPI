...
var ProductGroup = &crud.Resource{
	...
	Fields: []schema.Field{
		{Name: "product_group_name", Kind: schema.KindString, Required: true, MaxLen: 150, Label: "ชื่อกลุ่มสินค้า"},
		{Name: "description", Kind: schema.KindString, MaxLen: 255, Label: "คำอธิบาย"},
	},
}
...
var Customer = &crud.Resource{
	...
	Fields: []schema.Field{
		...
		{Name: "phone1", Kind: schema.KindString, MaxLen: 30, Label: "โทรศัพท์"},
		{Name: "phone2", Kind: schema.KindString, MaxLen: 30, Label: "โทรศัพท์สำรอง"},
...
var Vendor = &crud.Resource{
	...
	Fields: []schema.Field{
		{Name: "vendor_name", Kind: schema.KindString, Required: true, MaxLen: 200, Label: "ชื่อคู่ค้า"},
		{Name: "tax_id", Kind: schema.KindString, MaxLen: 20, Label: "เลขประจำตัวผู้เสียภาษี"},
		{Name: "branch_code", Kind: schema.KindString, MaxLen: 10, Label: "รหัสสาขา"},
		{Name: "branch_name", Kind: schema.KindString, MaxLen: 100, Label: "ชื่อสาขา"},
		{Name: "contact_person", Kind: schema.KindString, MaxLen: 100, Label: "ผู้ติดต่อ"},
