...
func Load() (*Config, error) {
	c := &Config{
		...
		// PORT มาก่อนเสมอ เพราะ platform ที่รันแบบ container (App Platform, Cloud Run,
		// Railway) กำหนดพอร์ตให้ผ่าน env ตัวนี้แล้วรอ probe ที่พอร์ตนั้น
		// ถ้าเราไป bind FIBER_PORT ค้างไว้ process จะถูกฆ่าทิ้ง
		// รันเองบนเครื่องไม่มีใครตั้ง PORT จึงตกไปใช้ FIBER_PORT ตามปกติ
